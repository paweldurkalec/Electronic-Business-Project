...
def add_item_to_cart(XPATH, amount=1):
    ...
    for i in range(0,amount-1):
        custom_sleep()
        driver.find_element(By.XPATH,
                            '/html/body/main/section/div/div/section/div[1]/div[2]/div[2]/div[2]/form/div[2]/div/div[1]/div/span[3]/button[1]/i').click()

    custom_sleep()
    #add to cart
    driver.find_element(By.XPATH, '/html/body/main/section/div/div/section/div[1]/div[2]/div[2]/div[2]/form/div[2]/div').click()
    custom_sleep()
    #continue shopping
    time.sleep(4)
...
def fill_cart():
    ...
    custom_sleep()
    #item 1
    add_item_to_cart('/html/body/main/section/div/div[2]/section/section/div[3]/div/div[1]/div[1]/article/div/a/img', 2)
    #item 2
    add_item_to_cart('/html/body/main/section/div/div[2]/section/section/div[3]/div/div[1]/div[5]/article/div/a/img', 3)
    #goto products
    driver.find_element(By.XPATH,'/html/body/main/header/div[2]/div/div[1]/div[2]/div[1]/ul/li/a').click()
    custom_sleep()
    #goto chainsaws
    ...
    custom_sleep()
    #item 3
    add_item_to_cart('/html/body/main/section/div/div[2]/section/section/div[3]/div/div[1]/div[2]/article/div/a/img', 1)
    #item 4
    add_item_to_cart('/html/body/main/section/div/div[2]/section/section/div[3]/div/div[1]/div[1]/article/div/a/img', 4)
...
def remove_item_from_cart():
    ...
    custom_sleep()
    custom_sleep()
    driver.find_element(By.XPATH,'/html/body/main/section/div/div/section/div/div[1]/div/div[2]/ul/li/div/div[3]/div/div[2]/div/div[1]/div/span[3]/button[2]').click()
    custom_sleep()
    custom_sleep()
...
def make_order():
    ...
    custom_sleep()
    #addres
    driver.find_element(By.XPATH,'/html/body/section/div/section/div/div[1]/section[2]/div/div/form/div/div/section/div[6]/div[1]/input').send_keys(ADDRES)
    custom_sleep()
    #post code
    driver.find_element(By.XPATH,'/html/body/section/div/section/div/div[1]/section[2]/div/div/form/div/div/section/div[8]/div[1]/input').send_keys(POST_CODE)
    custom_sleep()
    #city
    driver.find_element(By.XPATH, '/html/body/section/div/section/div/div[1]/section[2]/div/div/form/div/div/section/div[9]/div[1]/input').send_keys(CITY)
    custom_sleep()
    #forward
...
def check_status_of_order():
    ...
    custom_sleep()
    #orders history
    driver.find_element(By.XPATH, '/html/body/main/section/div/div/section/section/div/div/a[3]/span').click()
    custom_sleep()
    #order details
    driver.find_element(By.XPATH, '/html/body/main/section/div/div/section/section/table/tbody/tr/td[6]/a[1]').click()
    custom_sleep()

driver.get('https://localhost:18184')
fill_cart()
